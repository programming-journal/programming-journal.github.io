...
This page records the journal's policies on the use of artificial intelligence, both for authors and for reviewers. We aim to be consistent with the 
[Committee on Publication Ethics (COPE)](https://publicationethics.org/guidance/cope-position/authorship-and-ai-tools), 
and more specifically with the ACM policies on AI in 
[authorship](https://www.acm.org/publications/policies/new-acm-policy-on-authorship) and 
[reviewing](https://www.acm.org/publications/policies/peer-review-faq). 
The overarching principle is that AI tools for content creation may provide helpful assistance for scholarly processes, but cannot substitute for them. 
