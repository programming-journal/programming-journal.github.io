...
Three badges are available, based on, but not equivalent to, the [ACM artifact reviewing badges](https://www.acm.org/publications/policies/artifact-review-and-badging-current): _Available_, _Functional_, or _Reusable_ (details below).
